...
#define COCOAPODS_VERSION_MAJOR_GData 1
#define COCOAPODS_VERSION_MINOR_GData 9
#define COCOAPODS_VERSION_PATCH_GData 1

// GData/Core
#define COCOAPODS_POD_AVAILABLE_GData_Core
#define COCOAPODS_VERSION_MAJOR_GData_Core 1
#define COCOAPODS_VERSION_MINOR_GData_Core 9
#define COCOAPODS_VERSION_PATCH_GData_Core 1

// GData/XMLNode
#define COCOAPODS_POD_AVAILABLE_GData_XMLNode
#define COCOAPODS_VERSION_MAJOR_GData_XMLNode 1
#define COCOAPODS_VERSION_MINOR_GData_XMLNode 9
